...
class MyAccount extends React.Component {
  ...
  state = {
    firstName: localStorage.firstName2,
    lastName: localStorage.lastName2,
    email: localStorage.mail2,
    telephone: localStorage.telephone2,
    password: localStorage.ps2,
    showPassword: false,
    open: false,
...
export default graphql(Usermutation, {
  options: { variables: { id: localStorage.ids } },
})
