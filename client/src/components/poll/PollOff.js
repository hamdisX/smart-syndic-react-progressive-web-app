...
class PollOff extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            vt: '0',
                        ...
                        <Grid container spacing={16}>
                            ...
                            <Grid item xs={12} sm={6}>
                                ...
                                <FormControl component="fieldset" >
                                    ...
                                    <FormLabel component="legend"> {JSON.parse(localStorage.poll.title)}</FormLabel>
                                    <RadioGroup
                                    ...
                                    >
                                        {JSON.parse(localStorage.poll.options).map(n => {
                                            { i = i + 1 }
                                            return (
...
export default (withStyles(styles)(PollOff));
